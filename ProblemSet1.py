...
#%%
def problem1_1():
   # pass # replace this pass (a do-nothing) statement with your cod
    print("Problem Set 1")
...
#%%
def problem1_7():
    top=input("Enter the length of one of the bases:")
    bottom=input("Enter the length of the other base:")
    h=input("Enter the height:")
    first=float(top)
    second=float(bottom)
    hi=float(h)
    print("The area of a trapezoid with bases", first, "and", second, end='')
    print(" and height", hi, "is", (first+second)*hi/2)
